                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-item w-100">
                                        ...
                                        <input type="text" name="phone" class="form-control" placeholder="Masukkan nomor anda" required>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-item w-100">
                                    ...
                                    <div class="bg-light rounded">
                                        ...
                                        <div class="py-4 mb-4 d-flex justify-content-between">
                                            ...
                                            <div class="mb-0 pe-4 mb-3 pe-5">
                                                ...
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input bg-primary border-0" id="tunai" name="payment_method" value="tunai">
