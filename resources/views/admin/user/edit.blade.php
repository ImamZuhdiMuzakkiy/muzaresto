                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Masukkan Nama Karyawan" required value="{{ old('fullname', $user->fullname) }}">
                            </div>
                            <div class="form-group">
                                <label for="username">Username</label>
                                <input type="text" class="form-control" id="username" name="username" placeholder="Masukkan Username" value="{{ old('username', $user->username) }}" required>
                            </div>
                            <div class="form-group">
                                <label for="phone">No. Telepon</label>
                                <input type="text" class="form-control" id="phone" name="phone" placeholder="Masukkan No. Telepon" value="{{ old('phone', $user->phone) }}" required>
                            </div>
                            <div class="form-group">
